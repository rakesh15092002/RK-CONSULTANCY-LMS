...
*/
const versionSelector = (clerkJSVersion, packageVersion = "5.113.0") => {
	if (clerkJSVersion) return clerkJSVersion;
	const prereleaseTag = getPrereleaseTag(packageVersion);
	if (prereleaseTag) {
		if (prereleaseTag === "snapshot") return "5.113.0";
...
Object.defineProperty(exports, 'versionSelector', {
  enumerable: true,
  get: function () {
    return versionSelector;
  }
});
//# sourceMappingURL=versionSelector-BX12_LHK.js.map